        ...
        (dokter) => {
          const selectedSpecialist =
            state.searchSpecialist.value !== null
              ? state.searchSpecialist.value.toUpperCase()
              : "";
          return (
            dokter.specialist.toUpperCase().includes(selectedSpecialist) ||
            dokter.nama.toUpperCase().includes(selectedSpecialist)
          );
        }
      );
    } else {
